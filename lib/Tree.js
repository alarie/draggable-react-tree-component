...
const Tree = function (_React$Component) {
  (0, _inherits3.default)(Tree, _React$Component)

  function Tree(props) {
    (0, _classCallCheck3.default)(this, Tree)

    const _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Tree).call(this, props));
  ...
  (0, _createClass3.default)(Tree, [{
    ...
    value: function onDragEnterGap(e, treeNode) {
      const offsetTop = (0, _util.getOffset)(treeNode.selectHandle).top
    ...
    value: function onExpand(treeNode) {
      ...
      const expandedKeys = [].concat((0, _toConsumableArray3.default)(this.state.expandedKeys))
    ...
    value: function onCheck(treeNode) {
      ...
      const key = treeNode.props.eventKey
      let checkedKeys = [].concat((0, _toConsumableArray3.default)(this.state.checkedKeys))
    ...
    value: function onSelect(treeNode) {
      ...
      const selectedKeys = [].concat((0, _toConsumableArray3.default)(this.state.selectedKeys))
    ...
    value: function getDefaultSelectedKeys(props, willReceiveProps) {
      const getKeys = function getKeys(keys) {
        if (props.multiple) {
    ...
    value: function renderTreeNode(child, index) {
      const level = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2]
    ...
    value: function render() {
      ...
      if (props.checkable && (this.checkedKeysChange || props.loadData)) {
        if (props.checkStrictly) {
          ...
          (function () {
            const checkedKeys = _this4.state.checkedKeys
            let checkKeys = void 0
