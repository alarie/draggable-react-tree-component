  ...
  (0, _createClass3.default)(Tree, [{
    ...
    value: function onDragEnter(e, treeNode) {
      ...
      if (!enterGap) {
        ...
        this.dragEnterTimeouts[treeNode.props.eventKey] = setTimeout(function () {
          updateState();
    ...
    value: function stopDragEnterTimeout(key) {
      if (this.dragEnterTimeouts[key]) {
        clearTimeout(this.dragEnterTimeouts[key]);
        delete this.dragEnterTimeouts[key];
      }
    }
  }, {
    key: 'traverseToKey',
