...
var TreeNode = function (_React$Component) {
  ...
  (0, _createClass3.default)(TreeNode, [{
    ...
    value: function onDrop(e) {
      ...
      this.setState({
        dragNodeHighlight: false,
        dropNodeHighlight: true
      }, function () {
        window.setTimeout(function () {
          alert('here');
          // this.setState({
          //   dropNodeHighlight: false
          // })
        }, 2000);
      });
    ...
    value: function renderSelectHandle(props, selected) {
      ...
      var dropNodeHighlight = this.state.dropNodeHighlight;
      ...
      if (!props.disabled) {
        ...
        if (props.draggable) {
          ...
          domProps.className = (domProps.className || '') + ' ' + (dropNodeHighlight ? 'dropped' : '') + ' draggable ';
